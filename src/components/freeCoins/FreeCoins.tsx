...
export default function FreeCoins() {
    return (
        <div className="w-screen h-screen min-h-screen flex flex-col lg:flex-row justify-between items-center bg-[#4C42FD] relative overflow-hidden px-10 lg:px-20 py-24 lg:py-0">
